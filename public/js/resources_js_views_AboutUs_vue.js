    ...
    _c("nav", { attrs: { "aria-label": "breadcrumb" } }, [
      _c("ol", { staticClass: "breadcrumb" }, [
        _c(
          ...
          [_c("router-link", { attrs: { to: "/" } }, [_vm._v("Beranda")])],
          1
        ),
        _vm._v(" "),
        _c(
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "card border-0 shadow" }, [
      _c("div", { staticClass: "card-body" }, [
        _c("h3", [_vm._v("Tentang Kami")]),
        _vm._v(" "),
        _c("p", [
          _vm._v(
            "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Officia, provident doloribus! Doloribus eligendi nesciunt dignissimos, reprehenderit quasi exercitationem quod doloremque modi cum ipsam. Iure laboriosam qui voluptatum illo, velit nam dicta eaque dolore officiis facilis voluptates quos itaque quisquam reprehenderit cumque nobis similique perferendis corrupti nostrum laudantium reiciendis? Ducimus, similique explicabo nam ut ex vel quod error unde accusamus placeat natus mollitia fugit labore debitis repellat iure ipsum perferendis quas fuga, tenetur aspernatur? Minus, sed qui aspernatur soluta repellendus autem saepe quod alias quisquam amet deleniti omnis aliquid! Error incidunt optio, vitae quam molestias, blanditiis rerum ducimus laborum, commodi ex accusamus. Unde distinctio expedita omnis dicta voluptatem a quisquam ducimus exercitationem voluptates consequuntur. Maiores ipsum exercitationem accusantium eos quisquam, consectetur obcaecati dicta nesciunt. Perspiciatis dolorum quis nobis aliquid, quisquam facere aperiam iure, laborum praesentium voluptatum, ex beatae modi ad sunt dicta quas alias nam. Unde, rerum delectus porro nobis quasi qui similique? Non quia laborum culpa voluptatem. Perspiciatis, perferendis qui! Laboriosam rerum nisi quas placeat in, eius, suscipit voluptas commodi reiciendis alias sapiente tempora illo autem atque vel accusamus blanditiis aperiam. Sunt, fugiat possimus maxime debitis saepe et tempora, ut consequatur similique iure sit. In maiores dignissimos laboriosam officia voluptas."
          ),
        ]),
      ]),
    ])
