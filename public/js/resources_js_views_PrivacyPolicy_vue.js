"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_PrivacyPolicy_vue"],{
...
var render = function () {
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "mx-auto col-lg-10" }, [
      _c("h4", { staticClass: "fw-bold" }, [_vm._v("Kebijakan Privasi")]),
      _vm._v(" "),
      _c(
        "p",
        [
          _vm._v(
            "Ketentuan-ketentuan yang ada dalam halaman ini mengatur hal-hal menyangkut data-data Pengguna Situs yang diberikan oleh Pengguna Situs kepada Pengelola Situs dalam rangka pemanfaatan fasilitas atau fitur yang ditawarkan oleh Pengelola Situs melalui Situs "
          ),
          _c("router-link", { attrs: { to: "/" } }, [
            _vm._v("bem.stmik-bandung.ac.id"),
          ]),
          _vm._v("."),
        ],
        1
      ...
      _c("p", [
        _vm._v(
          "Ketentuan-ketentuan menyangkut data mengikat seluruh Pengguna Situs tanpa terkecuali untuk tunduk dan patuh atas ketentuan-ketentuan yang telah ditetapkan Pengelola Situs."
        ),
      ]),
      _vm._v(" "),
      _c("p", [
        _vm._v(
          "Ketentuan-ketentuan terkait data tersebut ialah sebagai berikut:"
        ),
      ]),
      _vm._v(" "),
      _vm._m(0),
...
var staticRenderFns = [
  function () {
    ...
    return _c("ol", [
      _c("li", [
        _vm._v(
          "Atas data-data yang diberikan oleh Pengguna Situs kepada Pengelola Situs sebagai pemenuhan syarat atas pemanfaatan fasilitas atau fitur yang ditawarkan oleh Pengelola Situs, maka Pengelola Situs berkewajiban untuk:\n        "
        ),
        _c("ol", { attrs: { type: "a" } }, [
          _c("li", [
            _vm._v(
              "Menjaga kerahasiaan data-data Pengguna yang tidak dapat ditampilkan dalam Situs dan/atau diberikan kepada pihak-pihak tertentu atas penggunaan fasilitas atau fitur Situs selama tidak ada perjanjian tertulis terlebih dahulu kepada Pengguna;"
            ),
          ]),
          _vm._v(" "),
          _c("li", [
      ...
      _c("li", [
        _vm._v(
          "Pengelola berhak untuk mengubah ketentuan menyangkut data-data Pengguna Situs tanpa pemberitahuan terlebih dahulu dengan tanpa mengabaikan hak Pengguna Situs untuk dijaga kerahasiaan datanya sebagaimana yang telah ditentukan dalam butir (1)."
        ),
      ]),
    ])
  },
  function () {
    ...
    return _c("p", { staticClass: "card-text" }, [
      _vm._v("Last updated: "),
      _c("strong", [_vm._v("Kamis, 17 Februari 2022")]),
    ])
  },
]
